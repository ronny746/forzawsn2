...
const getAllExpense = async (req: RequestType, res: Response): Promise<void> => {
  ...
  return {
    ...
    expenseDocs: docs,
    ApprovedAmount: approvedAmount // ✅ per claim approved amount
  };
});
...
res.status(200).json({
  ...
  TotalApprovedAmount: totalApproved,  // overall approved
  TotalRejectedAmount: totalRejected,  // overall rejected
  Data: {
