...
const approveDisapproveClaim = async (req: RequestType, res: Response, next: NextFunction) => { try {
        const { ExpenseReqId, isApprove, rejectReason, ExpenseDocId, approveAmount } = req.body;

        // ✅ Update main visitexpense table
        const updateMain = `
        ...
        await sequelize.query(updateMain, {
            replacements: {
                ...
                approveAmount: isApprove ? approveAmount : null,
                rejectReason,
                ExpenseReqId
            },
        ...
        const docData = await sequelize.query(`
            ...
            INNER JOIN dbo.visitexpense ve 
                ON ve.ExpenseReqId = ed.ExpenseReqId
