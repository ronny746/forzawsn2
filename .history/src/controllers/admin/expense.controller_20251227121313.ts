...
const generateDetailedExpenseReport = async (
    ...
    try {
        ...
        doc.fontSize(10).font("Helvetica-Bold")
            .text(
                `Total Expense for the Month of ${getMonthName(startDate.toString())}: ${grandTotal}`,
                startX,
                doc.y + 5
            );
        ...
        // Created By
        doc.fontSize(10).font("Helvetica")
            .text("Created By:", startX, signY);
        doc.moveTo(startX + 80, signY + 12).lineTo(startX + 80 + lineWidth, signY + 12).stroke();

        // Checked By
        doc.text("Checked By:", startX + 180, signY);
        doc.moveTo(startX + 300, signY + 12).lineTo(startX + 200 + lineWidth, signY + 12).stroke();

        // Approved By
        doc.text("Approved By:", startX + 320, signY);
        doc.moveTo(startX + 510, signY + 12).lineTo(startX + 410 + lineWidth, signY + 12).stroke();
