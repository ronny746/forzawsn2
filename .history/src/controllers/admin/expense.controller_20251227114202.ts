...
const generateDetailedExpenseReport = async (
    ...
    try {
        ...
        expenses.forEach((expense: any) => {
            ...
            if (expense.ExpenseType === 'Hotel') {
                ...
                if (expense.Reason === 'Metro') {
                    subtype = 'Metro';
                } else if (expense.Reason === 'Non-Metro') {
                    subtype = 'Non-Metro';
                } else if (expense.Reason === 'Self-Stay') {
                    subtype = 'Self-Stay';
                } else {
                ...
                if (expense.ConvModeDesc === 'Air') {
                    subtype = 'Air';
                } else if (expense.ConvModeDesc === 'Car') {
                    subtype = 'Car';
                } else if (expense.ConvModeDesc === 'Bike') {
                    subtype = 'Bike';
                } else if (expense.ConvModeDesc === 'Public Transport') {
        ...
        doc.fontSize(9).font('Helvetica')
            ...
            .text(`Department: ${employee.designation || 'N/A'}`, 50);
