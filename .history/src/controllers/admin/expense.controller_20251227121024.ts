...
const generateDetailedExpenseReport = async (
    ...
    try {
        ...
        // ===== SIGNATURE SECTION (Proper Aligned) =====
        const signY = doc.y;
        ...
        doc.text("____________________", startX + 70, signY);

        // Checked By
        doc.text("Checked By:", startX + 200, signY);
        doc.text("____________________", startX + 285, signY);

        // Approved By
        doc.text("Approved By:", startX + 400, signY);
        doc.text("____________________", startX + 490, signY);
