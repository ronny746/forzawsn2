...
appExpenseRouterV1.get('/get-expense-for-hr', jwtModule.verifyAccessToken, appExpenseController.getAllExpenseForHr);
...
appExpenseRouterV1.post('/bulk-approve-disapprove-claim-by-hr', jwtModule.verifyAccessToken, appExpenseController.approveDisapproveClaimByHr);
