...
const appAdminFileRouterV1 = Router();

appAdminFileRouterV1.post('/upload-attendence-image-local', jwtModule.verifyAccessToken, upload0.single('file'), appFileController.uploadAttendenceImageLocal);

export { appAdminFileRouterV1 };
